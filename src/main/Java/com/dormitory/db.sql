...
insert into maintenances(student_id,supervisor_id,repairer_id,item_id,repairer_type,fault_type,fault_location,fault_detail,fault_analysis,fault_state,reform_time,response_time,item_num,estimate_rate,estimate_detial)
values(2120101182,1001,105,4,"电工","电器损坏","教学楼E座教室151","一个灯泡损坏","正常损坏","修复","2017-05-07","2017-05-07",1,4.8,"很满意");

insert into maintenances(student_id,supervisor_id,repairer_id,item_id,repairer_type,fault_type,fault_location,fault_detail,fault_analysis,fault_state,reform_time,response_time,item_num,estimate_rate,estimate_detial)
values(2120101182,1001,105,4,"电工","电器损坏","公寓楼B座寝室413","卫生间灯泡损坏","正常损坏","修复","2017-04-07","2017-04-08",1,4.7,"较为满意");

insert into maintenances(student_id,supervisor_id,repairer_id,item_id,repairer_type,fault_type,fault_location,fault_detail,fault_analysis,fault_state,reform_time,response_time,item_num,estimate_rate,estimate_detial)
values(2120101182,1001,103,4,"水工","热水器问题","公寓楼B座寝室413","热水器的淋浴头出现裂缝","垃圾产品","修复","2017-05-07","2017-06-07",1,3.8,"维修效率低得可怕。绝对的差评！！！");

insert into maintenances(student_id,supervisor_id,repairer_id,item_id,repairer_type,fault_type,fault_location,fault_detail,fault_analysis,fault_state,reform_time,response_time,item_num,estimate_rate,estimate_detial)
values(2120101184,1002,102,null,"火工","暖气故障","教学楼E座教室151","暖气打开很久都感受不到暖和","暖气室的气压问题所致","修复","2017-02-27","2017-02-27",null,null,"");

DROP TABLE IF EXISTS checkcode;
create table checkcode(id bigint,
checkcode varchar(3)
);

insert into checkcode(id,checkcode) values(2120101182,"182");
insert into checkcode(id,checkcode) values(2120101183,"183");
insert into checkcode(id,checkcode) values(2120101181,"181");
insert into checkcode(id,checkcode) values(2120101184,"184");
insert into checkcode(id,checkcode) values(1001,"001");
insert into checkcode(id,checkcode) values(1002,"002");
insert into checkcode(id,checkcode) values(1034,"034");
insert into checkcode(id,checkcode) values(1035,"035");
insert into checkcode(id,checkcode) values(101,"101");
insert into checkcode(id,checkcode) values(102,"102");
insert into checkcode(id,checkcode) values(2120101191,"191");
insert into checkcode(id,checkcode) values(2120101192,"192");
insert into checkcode(id,checkcode) values(2120101193,"193");
insert into checkcode(id,checkcode) values(1008,"008");
insert into checkcode(id,checkcode) values(1036,"036");
insert into checkcode(id,checkcode) values(1003,"003");
insert into checkcode(id,checkcode) values(103,"003");
