                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (usernameCheck == "true") {
                            $("#checkResult").empty()
                            $("#checkResult").append("<font color='green'><p id='checkCor1'>可以使用的用户名</p></font>")
                            checkNumber=0;
                        }
                        else {
                            $("#checkResult").empty()
                            $("#checkResult").append("<font color='red'><p>已被使用的用户名</p></font>")
                            checkNumber=1;
                        }
                    },
                }, JSON)
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form role="form">
                ...
                <div class="form-group">
                    <label for="registerPassword">密码</label><input type="password" class="form-control" id="registerPassword" style="width: 20%"/><div id="registerPasswordNull"></div>
                </div>
                <div class="form-group">
